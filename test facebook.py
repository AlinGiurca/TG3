...
def runSeleniumDriver():
	chromedriver = "C:/Users/Roberto/Desktop/Catedra/chromedriver" #Donde tenga el chromedriver
...
#Obtención de los elementos de la página.
	...
	time.sleep(2)
	driver.find_element_by_name("reg_email__").send_keys("pedro.ram"+str(i)+"@hotmail.com")
	time.sleep(2)
	driver.find_element_by_name("reg_email_confirmation__").send_keys("pedro.ram"+str(i)+"@hotmail.com")
	time.sleep(2)
